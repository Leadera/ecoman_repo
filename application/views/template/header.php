...
<html lang="en">
  ...
  <body <?php if($this->uri->segment(1)=="is"){echo 'class="easyui-layout"';} ?> >
    ...
    <div style="background-color: rgb(240, 240, 240); padding: 10px 20px; margin-bottom: 20px;">
      <?php if ($this->session->userdata('user_in') !== FALSE): ?>
        <ul class="list-inline" style="margin:0px;">
          ...
          <li class="head-li"><a href="<?php echo base_url('isscoping'); ?>"><i class="fa fa-bar-chart"></i> Industrial Symbiosis Allocations</a></li>
        </ul>
      <?php else: ?>
