...
class Flow_model extends CI_Model {
	...
	public function get_company_flow_list($companyID){
		$this->db->select('T_FLOW.name as flowname,T_FLOW_TYPE.name  as flowtype,T_CMPNY_FLOW.id as cmpny_flow_id,T_CMPNY_FLOW.qntty as qntty,unit1.name as qntty_unit_name,T_CMPNY_FLOW.cost as cost,unit2.name as cost_unit_name,T_CMPNY_FLOW.ep as ep,unit3.name as ep_unit_name');
