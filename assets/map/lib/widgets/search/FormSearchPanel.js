...
/** api: example
 *  Sample code showing how to configure a Ostim FormSearchPanel.
 ...
 */
Ostim.widgets.search.FormSearchPanel = Ext.extend(GeoExt.form.FormPanel, {
...
// See also: http://ian01.geog.psu.edu/geoserver_docs/apps/gaz/search.html
    initComponent: function () {
        ...
        Ostim.widgets.search.FormSearchPanel.superclass.initComponent.call(this);
        ...
        if (this.protocol && this.protocol.url instanceof Array) {
            this.protocol.url = Ostim.Utils.randArrayElm(this.protocol.url);
    ...
    createStatusPanel: function () {
        return this.statusPanel = new Ostim.widgets.HTMLPanel(this.statusPanelOpts);
    },
    ...
    onSearchIssued: function (form, action) {
        ...
        this.timer = setInterval(function () {
            ...
            self.updateStatusPanel(Math.floor(new Date().getTime() / 1000 - startTime) +
                    ' ' + __('Seconds') + ' - ' +
                    Ostim.Utils.randArrayElm(self.progressMessages));
        }, 4000);
    },
    ...
    search: function () {
        this.action = null;
        Ostim.widgets.search.FormSearchPanel.superclass.search.call(this, {
...
Ext.reg('hr_formsearchpanel', Ostim.widgets.search.FormSearchPanel);

// For compatibility with pre v0.73. Ostim.widgets.SearchPanel was renamed to Ostim.widgets.search.FormSearchPanel
/** api: xtype = hr_searchpanel */
Ext.reg('hr_searchpanel', Ostim.widgets.search.FormSearchPanel);
