...
(function() {
  ...
  var singleFile = (typeof Ostim == "object" && Ostim.singleFile);

  /**
   * Relative path of this script.
   */
  var scriptName = (!singleFile) ? "lib/DynLoader.js" : "Ostim.js";
  var jsFiles = window.ostim;
  window.ostim = {
    /**
  ...
  /**
   * ostim.singleFile is a flag indicating this file is being included
  ...
  if (!singleFile) {
    if (!jsFiles) {
      jsFiles = [
        ...
        "widgets/search/ZeynelInfoPopup.js",
        "widgets/search/ZeynelInfoPanel.js",
        "widgets/search/ZeynelFeaturePanel.js",
      ];
    }
    ...
    var host = ostim._getScriptLocation() + "lib/";
