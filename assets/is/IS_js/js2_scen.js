function beginISPotentialByAllFlows() {
            $.messager.confirm('Confirm','Are you sure ? New Table with new data will be deployed...',function(r){
                    if (r){
                        ...
                        $.ajax({
                        url: 'http://88.249.18.205:8090/slim_rest/index.php/columnflows_json_test',
                        type: 'GET',
                        dataType : 'json',
                        ...
                        success: function(data, textStatus, jqXHR) {
                          console.warn('success text status-->'+textStatus);
                            ...
                            $('#tt_grid2').datagrid({
                                  ...
                                  url:'http://88.249.18.205:8090/slim_rest/index.php/companies_json_test2',
                                  method:'get',
                                  idField:'id',
                                  toolbar:'#tb',
                                  remoteSort:true,
                                  ...
                                  onDblClickRow: function(rowIndex, rowData){
                                        ...
                                        $.ajax({
                                            url: 'http://88.249.18.205:8090/slim_rest/index.php/flows',
                                            type: 'GET',
                                            dataType : 'json',
                                            data: 'rowIndex='+rowData.id,
                                            success: function(data, textStatus, jqXHR) {
        ...
        function beginISPotentialByFlows() {
            $.messager.confirm('Confirm','Are you sure ? New Table with new data will be deployed...',function(r){
                    if (r){
                        ...
                        $.ajax({
                            url: 'http://88.249.18.205:8090/slim_rest/index.php/flowsAndCompanies_json_test',
                            type: 'GET',
                            dataType : 'json',
                            ...
                            success: function(data, textStatus, jqXHR) {
                              ...
                              $('#tt_grid2').datagrid({
                                 ...
                                 url : 'http://88.249.18.205:8090/slim_rest/index.php/flowsAndCompanies_json_test?flows='+JSON.stringify(arrayLeaf)
                            });
                           /*$("#tt_tree2").tree({
                                checkbox :false
                            });*/
        ...
        function submitForm(){
           // $('#ff').form('submit');
            ...
            $.ajax({
                url: 'http://88.249.18.205:8090/slim_rest/index.php/insertIS',
                type: 'POST',
                dataType : 'json',
        ...
        function getFlowCompanies(index,flowName, companyID) {
            $('#tt_grid_dynamic3').datagrid({  
                      ...
                      singleSelect: true,
                      //
                      url: 'http://88.249.18.205:8090/slim_rest/index.php/flowCompanies_json_test?flowid='+index+'&IS3='+$('#IS_search2').combobox('getValue')+'&cmpny_id='+companyID,
                   });
                   $('#tt_grid_dynamic3').datagrid('getPanel').panel("setTitle",flowName);
            /*$.ajax({
                url: '../slim_rest/index.php/flowCompanies_json_test?flowid='+index+'&IS3='+$('#IS_search2').combobox('getValue')+'&cmpny_id='+companyID,
                type: 'GET',
                dataType : 'json',
                //data: 'rowIndex='+rowData.id,
                success: function(data, textStatus, jqXHR) {
        ...
        function getCompanyFlows(index,companyName) {
            ...
            $('#tt_grid_dynamic2').datagrid({  
                ...
                rownumbers: "true",
                pagination: "true",
                url:'http://88.249.18.205:8090/slim_rest/index.php/companyFlows_json_test?companyid='+index+'&IS2='+$('#IS_search2').combobox('getValue')
             });
            
            /*$.ajax({
                url: '../slim_rest/index.php/companyFlows_json_test?companyid='+index+'&IS2='+$('#IS_search2').combobox('getValue'),
                type: 'GET',
                dataType : 'json',
                //data: 'rowIndex='+rowData.id,
                success: function(data, textStatus, jqXHR) {
    ...
    $('#tt_tree2').tree({
        ...
        //url : '../slim_rest/index.php/flowsManual',
        url : 'http://88.249.18.205:8090/slim_rest/index.php/flows',
        //url:'tree_data1.json',
        method:'get',
        animate:true,
    ...
    $.ajax({
        ...
        var dg = $('#tt_grid2').datagrid();
          ...
          $('#tt_grid_scenarios2').datagrid({
                ...
                collapsible:true,
                /*url:'datagrid_data1.json',*/
                url:'http://88.249.18.205:8090/slim_rest/index.php/ISScenarios',
                method:'get',
                idField:'id',
                /*toolbar:'#tb',*/
                remoteSort:false,
